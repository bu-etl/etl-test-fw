...
package GBT_SC_CTRL is
  type GBT_SC_MASTER_RX_RX_MON_t is record
  ...
  end record GBT_SC_MASTER_RX_RX_MON_t;
  type GBT_SC_MASTER_RX_RX_MON_t_ARRAY is array(0 to 2) of GBT_SC_MASTER_RX_RX_MON_t;

  type GBT_SC_MASTER_RX_MON_t is record
    RX                         :GBT_SC_MASTER_RX_RX_MON_t_ARRAY;
  end record GBT_SC_MASTER_RX_MON_t;


  type GBT_SC_MASTER_MON_t is record
    ...
    RX                         :GBT_SC_MASTER_RX_MON_t;       
  end record GBT_SC_MASTER_MON_t;


  type GBT_SC_MASTER_CTRL_t is record
  ...
  end record GBT_SC_MASTER_CTRL_t;


  constant DEFAULT_GBT_SC_MASTER_CTRL_t : GBT_SC_MASTER_CTRL_t := (
                                                                   TX_RESET => '0',
                                                                   RX_RESET => '0',
                                                                   TX_START_WRITE => '0',
                                                                   TX_START_READ => '0',
  ...
  type GBT_SC_SLAVE_MON_t is record
    RX_DATA_FROM_GBTX          :std_logic_vector( 7 downto 0);  -- Data from the FIFO
    TX_READY                   :std_logic;                      -- IC core ready for a transaction
    RX_EMPTY                   :std_logic;                      -- Rx FIFO is empty (no reply from GBTx)
  end record GBT_SC_SLAVE_MON_t;


  type GBT_SC_SLAVE_CTRL_t is record
    TX_RESET                   :std_logic;     -- Reset TX datapath
    RX_RESET                   :std_logic;     -- Reset RX datapath
    TX_START_WRITE             :std_logic;     -- Request a write config to the GBTx (IC)
    TX_START_READ              :std_logic;     -- Request a read config to the GBTx (IC)
    ...
    TX_WR                      :std_logic;                      -- Request a write operation into the internal FIFO (Data to GBTx)
    RX_RD                      :std_logic;                      -- Request a read operation of the internal FIFO (GBTx reply)
  end record GBT_SC_SLAVE_CTRL_t;


  constant DEFAULT_GBT_SC_SLAVE_CTRL_t : GBT_SC_SLAVE_CTRL_t := (
                                                                 TX_RESET => '0',
                                                                 RX_RESET => '0',
                                                                 TX_START_WRITE => '0',
                                                                 TX_START_READ => '0',
  ...
  type GBT_SC_MON_t is record
    MASTER                     :GBT_SC_MASTER_MON_t;
    SLAVE                      :GBT_SC_SLAVE_MON_t; 
  end record GBT_SC_MON_t;


  type GBT_SC_CTRL_t is record
    MASTER                     :GBT_SC_MASTER_CTRL_t;
    SLAVE                      :GBT_SC_SLAVE_CTRL_t; 
  end record GBT_SC_CTRL_t;


  constant DEFAULT_GBT_SC_CTRL_t : GBT_SC_CTRL_t := (
                                                     MASTER => DEFAULT_GBT_SC_MASTER_CTRL_t,
                                                     SLAVE => DEFAULT_GBT_SC_SLAVE_CTRL_t
                                                    );


end package GBT_SC_CTRL;