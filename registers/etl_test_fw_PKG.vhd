...
package etl_test_fw_CTRL is
  type etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_MON_t is record
    READY                      :std_logic;     -- LPGBT Uplink Ready
    FEC_ERR_CNT                :std_logic_vector(15 downto 0);  -- Data Corrected Count
  end record etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_MON_t;
  type etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_MON_t_ARRAY is array(0 to 1) of etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_MON_t;

  type etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t is record
    RESET                      :std_logic;     -- Reset this Uplink
  end record etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t;
  type etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t_ARRAY is array(0 to 1) of etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t;

  constant DEFAULT_etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t : etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t := (
                                                                                                               RESET => '0'
                                                                                                              );
  type etl_test_fw_CSM_LPGBT_UPLINK_MON_t is record
    UPLINK                     :etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_MON_t_ARRAY;
  end record etl_test_fw_CSM_LPGBT_UPLINK_MON_t;


  type etl_test_fw_CSM_LPGBT_UPLINK_CTRL_t is record
    UPLINK                     :etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t_ARRAY;
  end record etl_test_fw_CSM_LPGBT_UPLINK_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_LPGBT_UPLINK_CTRL_t : etl_test_fw_CSM_LPGBT_UPLINK_CTRL_t := (
                                                                                                 UPLINK => (others => DEFAULT_etl_test_fw_CSM_LPGBT_UPLINK_UPLINK_CTRL_t )
                                                                                                );
  type etl_test_fw_CSM_LPGBT_DOWNLINK_MON_t is record
    READY                      :std_logic;     -- LPGBT Downlink Ready
  end record etl_test_fw_CSM_LPGBT_DOWNLINK_MON_t;


  type etl_test_fw_CSM_LPGBT_DOWNLINK_CTRL_t is record
    RESET                      :std_logic;     -- Reset this Downlink
  end record etl_test_fw_CSM_LPGBT_DOWNLINK_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_LPGBT_DOWNLINK_CTRL_t : etl_test_fw_CSM_LPGBT_DOWNLINK_CTRL_t := (
                                                                                                     RESET => '0'
                                                                                                    );
  type etl_test_fw_CSM_LPGBT_MON_t is record
    UPLINK                     :etl_test_fw_CSM_LPGBT_UPLINK_MON_t;
    DOWNLINK                   :etl_test_fw_CSM_LPGBT_DOWNLINK_MON_t;
  end record etl_test_fw_CSM_LPGBT_MON_t;


  type etl_test_fw_CSM_LPGBT_CTRL_t is record
    UPLINK                     :etl_test_fw_CSM_LPGBT_UPLINK_CTRL_t;
    DOWNLINK                   :etl_test_fw_CSM_LPGBT_DOWNLINK_CTRL_t;
  end record etl_test_fw_CSM_LPGBT_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_LPGBT_CTRL_t : etl_test_fw_CSM_LPGBT_CTRL_t := (
                                                                                   UPLINK => DEFAULT_etl_test_fw_CSM_LPGBT_UPLINK_CTRL_t,
                                                                                   DOWNLINK => DEFAULT_etl_test_fw_CSM_LPGBT_DOWNLINK_CTRL_t
                                                                                  );
  type etl_test_fw_CSM_SC_MASTER_RX_RX_MON_t is record
  ...
  end record etl_test_fw_CSM_SC_MASTER_RX_RX_MON_t;
  type etl_test_fw_CSM_SC_MASTER_RX_RX_MON_t_ARRAY is array(0 to 2) of etl_test_fw_CSM_SC_MASTER_RX_RX_MON_t;

  type etl_test_fw_CSM_SC_MASTER_RX_MON_t is record
    RX                         :etl_test_fw_CSM_SC_MASTER_RX_RX_MON_t_ARRAY;
  end record etl_test_fw_CSM_SC_MASTER_RX_MON_t;


  type etl_test_fw_CSM_SC_MASTER_MON_t is record
    ...
    RX                         :etl_test_fw_CSM_SC_MASTER_RX_MON_t;
  end record etl_test_fw_CSM_SC_MASTER_MON_t;


  type etl_test_fw_CSM_SC_MASTER_CTRL_t is record
  ...
  end record etl_test_fw_CSM_SC_MASTER_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_SC_MASTER_CTRL_t : etl_test_fw_CSM_SC_MASTER_CTRL_t := (
                                                                                           TX_RESET => '0',
                                                                                           RX_RESET => '0',
                                                                                           TX_START_WRITE => '0',
                                                                                           TX_START_READ => '0',
  ...
  type etl_test_fw_CSM_SC_SLAVE_MON_t is record
    RX_DATA_FROM_GBTX          :std_logic_vector( 7 downto 0);  -- Data from the FIFO
    TX_READY                   :std_logic;                      -- IC core ready for a transaction
    RX_EMPTY                   :std_logic;                      -- Rx FIFO is empty (no reply from GBTx)
  end record etl_test_fw_CSM_SC_SLAVE_MON_t;


  type etl_test_fw_CSM_SC_SLAVE_CTRL_t is record
    TX_RESET                   :std_logic;     -- Reset TX datapath
    RX_RESET                   :std_logic;     -- Reset RX datapath
    TX_START_WRITE             :std_logic;     -- Request a write config to the GBTx (IC)
    TX_START_READ              :std_logic;     -- Request a read config to the GBTx (IC)
    ...
    TX_WR                      :std_logic;                      -- Request a write operation into the internal FIFO (Data to GBTx)
    RX_RD                      :std_logic;                      -- Request a read operation of the internal FIFO (GBTx reply)
  end record etl_test_fw_CSM_SC_SLAVE_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_SC_SLAVE_CTRL_t : etl_test_fw_CSM_SC_SLAVE_CTRL_t := (
                                                                                         TX_RESET => '0',
                                                                                         RX_RESET => '0',
                                                                                         TX_START_WRITE => '0',
                                                                                         TX_START_READ => '0',
  ...
  type etl_test_fw_CSM_SC_MON_t is record
    MASTER                     :etl_test_fw_CSM_SC_MASTER_MON_t;
    SLAVE                      :etl_test_fw_CSM_SC_SLAVE_MON_t; 
  end record etl_test_fw_CSM_SC_MON_t;


  type etl_test_fw_CSM_SC_CTRL_t is record
    MASTER                     :etl_test_fw_CSM_SC_MASTER_CTRL_t;
    SLAVE                      :etl_test_fw_CSM_SC_SLAVE_CTRL_t; 
  end record etl_test_fw_CSM_SC_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_SC_CTRL_t : etl_test_fw_CSM_SC_CTRL_t := (
                                                                             MASTER => DEFAULT_etl_test_fw_CSM_SC_MASTER_CTRL_t,
                                                                             SLAVE => DEFAULT_etl_test_fw_CSM_SC_SLAVE_CTRL_t
                                                                            );
  type etl_test_fw_CSM_MON_t is record
    LPGBT                      :etl_test_fw_CSM_LPGBT_MON_t;
    SC                         :etl_test_fw_CSM_SC_MON_t;   
  end record etl_test_fw_CSM_MON_t;


  type etl_test_fw_CSM_CTRL_t is record
    LPGBT                      :etl_test_fw_CSM_LPGBT_CTRL_t;
    SC                         :etl_test_fw_CSM_SC_CTRL_t;   
  end record etl_test_fw_CSM_CTRL_t;


  constant DEFAULT_etl_test_fw_CSM_CTRL_t : etl_test_fw_CSM_CTRL_t := (
                                                                       LPGBT => DEFAULT_etl_test_fw_CSM_LPGBT_CTRL_t,
                                                                       SC => DEFAULT_etl_test_fw_CSM_SC_CTRL_t
                                                                      );
  type etl_test_fw_MON_t is record
    CSM                        :etl_test_fw_CSM_MON_t;
  end record etl_test_fw_MON_t;


  type etl_test_fw_CTRL_t is record
    CSM                        :etl_test_fw_CSM_CTRL_t;
  end record etl_test_fw_CTRL_t;


  constant DEFAULT_etl_test_fw_CTRL_t : etl_test_fw_CTRL_t := (
                                                               CSM => DEFAULT_etl_test_fw_CSM_CTRL_t
                                                              );


end package etl_test_fw_CTRL;